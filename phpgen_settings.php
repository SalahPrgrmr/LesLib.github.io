...
{
    $result = array();
    $result[] = array('caption' => 'التصنيف', 'short_caption' => 'التصنيف', 'filename' => 'categories.php', 'name' => 'categories', 'group_name' => 'Default', 'add_separator' => false, 'description' => '');
    $result[] = array('caption' => 'الدروس', 'short_caption' => 'الدروس', 'filename' => 'lessons.php', 'name' => 'lessons', 'group_name' => 'Default', 'add_separator' => false, 'description' => '');
    return $result;
}
...
function GetMailer()
{
    $smtpOptions = new SMTPOptions('smtp.gmail.com', 587, true, '', '', '');
    $mailerOptions = new MailerOptions(MailerType::SMTP, '', 'Eng.Salah Hamoud | Library', $smtpOptions);
